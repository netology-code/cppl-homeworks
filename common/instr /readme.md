...
Если раньше мы были ограничены правилами C++, что массив типа int содержит элементы типа int, массив типа float содержит элементы типа float и т.д., то с появлением кортежей в стандарте C++11 появилась возможность , которые можно хранить в коллекции.
