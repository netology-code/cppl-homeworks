...
### constexpr - функции 
Для того чтобы функция могла быть вычислена на этапе компиляции, необходимо добавить к ней спецификатор constexpr
...
Далее в коде объявляется переменная val и инициализируется результатом вызова функции sum с аргументами 5 и 12. Так как вызов функции sum происходит на этапе компиляции, переменная val также будет вычислена на этапе компиляции.
