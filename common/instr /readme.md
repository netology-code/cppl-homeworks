...
В случае, если в контейнере содержатся элементы кастомного класса, в переменной i постоянно будет происходить копирование. И чтобы этого не было можно использовать ссылку &.

![Image alt](https://github.com/netology-code/cppl-homeworks/blob/main/common/19.PNG)

Но лучшей практикой, если вы не модифицируете, будет использование «const auto &»
