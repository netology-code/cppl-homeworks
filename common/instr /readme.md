...
![image](https://github.com/netology-code/cppl-homeworks/assets/147130852/549b612f-2b01-489d-b352-45a1bcc621f0)

Код вызовет ошибку компиляции. 

![image](https://github.com/netology-code/cppl-homeworks/assets/147130852/22cafcf3-f6c5-4ef0-8145-138c0fdb76d0)
...
![50](https://github.com/netology-code/cppl-homeworks/assets/147130852/d761bee5-9daa-49ef-b6d5-52eb923c4638)

В данном фрагменте кода выполняются следующие действия:

Инициализируется целочисленная переменная val значением 0.

Затем определяется лямбда-функция func, которая захватывает переменную val по ссылке (что означено символом &) и увеличивает её значение на 1.

Используется функция std::cout для вывода значения val. В этот момент оно равно 0, так func еще не вызвана.

Затем вызывается func(), которая увеличивает значение val на один.

Наконец, функция std::cout снова выводит значение val, но на этот раз оно равно 1, так как val был увеличен на один внутри func.

![image](https://github.com/netology-code/cppl-homeworks/assets/147130852/b4c39f8f-8b14-45db-b4f7-1c6e02612e04)
