# Задача 1. Копирование умных массивов

### Описание
В этом задании вам необходимо будет написать тесты для некоторых функций двусвзяного списка.
Для начала нужно добавить Catch2 в ваш проект ([ссылка](https://github.com/catchorg/Catch2/blob/devel/docs/cmake-integration.md))
