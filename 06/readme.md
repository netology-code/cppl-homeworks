# Домашнее задание к занятию "Функторы"

Выполнив это задание, вы познакомитесь с функторами и научитесь использовать их на практике.

### Цель задания

1. Научиться использовать функторы
...
[Счетчик чисел](https://github.com/netology-code/cppl-homeworks/tree/main/06/01)
